...
def write_status_messages(message, day):
    ...
    # и новое значение записывается в файл (на случай внезапной остановки программы)
    if day != day_status:
        day_status = day
...
# 1.хочу сделать чтобы программа работала только с 8 до 20 часов по местному времени
# в остальное время не висела на сервере волейбольном
...
# Это по замыслу
while True:
    if current_minute >= fixed_minute + 1 and current_minute < fixed_minute + 2:
